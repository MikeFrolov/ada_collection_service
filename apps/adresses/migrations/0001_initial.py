    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_address', models.CharField(blank=True, choices=[('Company address', 'Адреса компанії'), ('Legal address', 'Адреса реєстрації'), ('Physical address', 'Адреса проживання'), ('Work address', 'Адреса працевлаштування')], default='Legal address', max_length=16, verbose_name='Тип адреси')),
                ('index', models.CharField(blank=True, max_length=8, verbose_name='Індекс')),
                ('country', models.CharField(default='Україна', max_length=50, verbose_name='Країна')),
                ...
                ('apartment_number', models.CharField(blank=True, max_length=6, verbose_name='Номер приміщення')),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contractor_managers.contractormanager', verbose_name='Менеджер контрагента')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apartment_type', models.CharField(blank=True, choices=[('кв.', 'Квартира'), ('оф.', 'Офіс')], max_length=9, verbose_name='Тип приміщення')),
                ('apartment_number', models.CharField(blank=True, max_length=6, verbose_name='Номер приміщення')),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contractors.contractor', verbose_name='Контрагент')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apartment_type', models.CharField(blank=True, choices=[('кв.', 'Квартира'), ('оф.', 'Офіс')], max_length=9, verbose_name='Тип приміщення')),
                ('apartment_number', models.CharField(blank=True, max_length=6, verbose_name='Номер приміщення')),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='clients.client', verbose_name='Клієнт')),
            ],
            options={
