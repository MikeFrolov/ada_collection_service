    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_date', models.DateTimeField(verbose_name='Дата оновлення')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='debts.client', verbose_name='Клієнт')),
                ('contractor_manager', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='debts.contractormanager', verbose_name='Менеджер контрагента')),
